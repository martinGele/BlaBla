...
public class PrivacyPolicyFragment extends Fragment implements RefreshListner {
    ...
    private String SCREEN_NAME = "Privacy policy Fragment";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        URL = getResources().getString(R.string.URL_PRIVACY_URL);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
         ...
         */
        Fonts.fontFinkHeavyRegularTextView(headerText, (int) (getActivity().getResources().getDimension(R.dimen.header_font_size) / getActivity().getResources().getDisplayMetrics().density),
